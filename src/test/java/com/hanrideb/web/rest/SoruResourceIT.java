...
import com.hanrideb.repository.SoruRepository;
...
class SoruResourceIT {
    ...
    public static Soru createEntity(EntityManager em) {
        Soru soru = new Soru().cevap(DEFAULT_CEVAP);
        return soru;
    }
    ...
    public static Soru createUpdatedEntity(EntityManager em) {
        Soru soru = new Soru().cevap(UPDATED_CEVAP);
        return soru;
    }
    ...
    void putNewSoru() throws Exception {
        ...
        updatedSoru.cevap(UPDATED_CEVAP);
    ...
    void partialUpdateSoruWithPatch() throws Exception {
        ...
        partialUpdatedSoru.cevap(UPDATED_CEVAP);
